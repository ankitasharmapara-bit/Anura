Anura - AI Mental Health Companion
...
No additional setup required - Firebase is configured for immediate use
Usage

Start: Click "Start" on the landing page
Authenticate: Create an account or sign in with existing credentials
Assessment: Complete the mental health questionnaire honestly
Results: Review your personalized assessment results and recommendations
📁 Project Structure
